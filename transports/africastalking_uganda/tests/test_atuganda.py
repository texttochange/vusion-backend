...
from transports.africastalking_uganda.atuganda import (
    ATUgandaTransport, ATUgandaTransportV2)
from vumi.transports.tests.helpers import TransportHelper


class TestATUgandaTransport(VumiTestCase):

    transport_class = ATUgandaTransport
    ...
    def tearDown(self):
        ...
        yield super(TestATUgandaTransport, self).tearDown()

    def handle_request(self, request):
        if request.args.get('username') != [self.valid_creds['mt_username']]:
            request.setResponseCode(401)
        elif request.args.get('to') != ['2371234567']:
...
class TestATUgandaTransportV2(TestATUgandaTransport):
    transport_class = ATUgandaTransportV2
