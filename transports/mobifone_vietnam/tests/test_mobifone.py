...
from transports.mobifone_vietnam.mobifone import MobifoneTransport
from vumi.transports.apposit.tests.test_apposit import TestAppositTransport
from vumi.tests.helpers import VumiTestCase
from vumi.transports.tests.helpers import TransportHelper


class TestMobifoneTransport(TestAppositTransport):
    ...
    def setUp(self):
        ...
        self.tx_helper = self.add_helper(
            TransportHelper(
                MobifoneTransport, transport_addr='8123',
                mobile_addr='84901775940'))
    ...
    def tearDown(self):
        ...
        yield super(TestMobifoneTransport, self).tearDown()
    ...
    def test_inbound(self):
        ...
        self.assert_message_fields(msg,
            ...
            transport_type='sms',
            from_addr='84901775940',
            to_addr='8123',
            content='so many dynamos',
            provider='mobifone',
            transport_metadata={'mobifone': {'isBinary': 'true'}})
    ...
    def test_outbound(self):
        ...
        self.assert_outbound_request(request, **{
            'msg_name': 'login',
            'session_id': '838e59fd0a36124b50cd56b6f12eca220a36124b50cd56b6',
            'error_code':1,
            'error_detail': '1|SUCCESS'})
