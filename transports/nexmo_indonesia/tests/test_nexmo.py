...
from transports.nexmo_indonesia.nexmo import NexmoTransport
from vumi.transports.apposit.tests.test_apposit import TestAppositTransport
from vumi.tests.helpers import VumiTestCase
from vumi.transports.tests.helpers import TransportHelper


class TestNexmoTransport(TestAppositTransport):
    ...
    def setUp(self):
        ...
        self.tx_helper = self.add_helper(
            TransportHelper(
                NexmoTransport, transport_addr='8123',
    ...
    def tearDown(self):
        ...
        yield super(TestNexmoTransport, self).tearDown()
